    ...
    if event.sender_id in SUDO_USERS:
        ...
        try:
            if len(altron) == 3:
                ...
                await event.reply(f"😈 **Usage:**\n  » {hl}spam 10 Yaduvanshi\n  » {hl}spam 10 <ʀᴇᴘʟʏ ᴛᴏ ᴛᴇxᴛ>\n\n**To do spam with replying to a user:**\n  » {hl}spam 10 Yaduvanshi <ʀᴇᴘʟʏ ᴛᴏ ᴜꜱᴇʀ>")
    ...
    if event.sender_id in SUDO_USERS:
        if event.chat_id in GROUP:
            ...
            try:
                ...
                await event.reply(f"🔞 **Usage:**  {hl}pspam 10")
            except Exception as e:
                print(e)
...
async def hang(e):
    if e.sender_id in SUDO_USERS:
        if e.chat_id in GROUP:
            await e.reply("» ʟᴏʟ, ᴛʜɪꜱ ɪꜱ ᴛᴇᴀᴍ 𓆩𝗫𝗗𓆪 ᴘʀᴏᴛᴇᴄᴛᴇᴅ ɢʀᴏᴜᴘ.")
        else:
            try:
